...
namespace U5
{
    public class AvlTree<Person> where Person : IComparable<Person>
    {
        public class Node
        {
        ...
        public Node Search(Person searchKey)
        {
            return Search(searchKey, Root);
        }

        private Node Search(Person searchKey, Node currentNode)
        {
        ...
        private Node StandardInsert(Person key)
        {
